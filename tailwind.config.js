...
module.exports = {
  ...
  safelist: [
    ...
    'bg-rose-500','bg-cyan-500','bg-indigo-500','bg-pink-500','bg-orange-500','bg-teal-500',
    'border-blue-200','border-violet-200','border-emerald-200','border-amber-200',
    'text-blue-600','text-violet-600','text-emerald-600','text-amber-600','text-rose-600',
    'bg-blue-50','bg-violet-50','bg-emerald-50','bg-amber-50','bg-rose-50','bg-cyan-50','bg-indigo-50','bg-pink-50',
  ],
  theme: {
    extend: {
